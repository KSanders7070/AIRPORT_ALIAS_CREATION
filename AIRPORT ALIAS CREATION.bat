...
TITLE CREATE AIRPORT ALIAS FILES (Beta 2.4.2)
...
ECHO * * * * * * * * * * * * * * * * *
ECHO    VERSION: BETA 2.4.2
ECHO    PUBLISHED: 18APR2020 01:45Z
ECHO * * * * * * * * * * * * * * * * *
ECHO.
ECHO 1) Added a link to be opened by the Help Menu ^> "Is this Safe" issue.
ECHO.
ECHO 2) Added the vZLC ARTCC Command Reference page to the HELP menu for help with understanding the output syntax.
echo.
echo.
echo.
echo.
...
echo.
ECHO * * * * * * * * * * * * * * * * *
ECHO    VERSION: BETA 2.4.1
ECHO    PUBLISHED: 06:45Z
ECHO * * * * * * * * * * * * * * * * *
ECHO.
ECHO 1) The Batch file now remembers if an airport issues a PDC.
echo.
echo.
echo.
echo.
...
echo.
ECHO * * * * * * * * * * * * * * * * *
ECHO    VERSION: BETA 2.4
ECHO    PUBLISHED: 17APR2020 04:00Z
ECHO * * * * * * * * * * * * * * * * *
ECHO.
ECHO 1) Fixed issue where it would hold on to the initial climb altitude from a previous DP and insert it into the next DP.
echo.
echo.
echo.
echo.
...
ECHO    PUBLISHED: 17APR2020 03:30Z
ECHO * * * * * * * * * * * * * * * * *
ECHO.
ECHO 1) Added a Help section to the splash page.
ECHO.
ECHO 2) Now opens the command reference page that the alias syntax was built from so that the user
echo    may reference it when needed.
echo.
echo 3) Combined a couple initial notification pages.
echo.
echo 4) Fixed crash for MULTI_IAP==Y query after User input the IAP scratchpad code.
echo.
echo 5) Fixed crash after user inputs the IAP fixes.
echo.
echo.
echo.
echo.
...
echo.
ECHO * * * * * * * * * * * * * * * * *
ECHO    VERSION: BETA 2.2
ECHO    PUBLISHED: 14APR2020 18:20z
ECHO * * * * * * * * * * * * * * * * *
ECHO.
ECHO 1) Removed redundant queries about asking if the field is TWR'd or if the airport issues PDCs.
ECHO.
ECHO 2) Added a suggestion to run the CMD Prompt window full-screen.
ECHO.
ECHO 3) Revised the Approach Assignment ScratchPad section to include a more comprehensive standard
echo    along with removing the recognition of difference between RNAV GPS vs RNAV RNP.
echo.
echo 4) New PDC format that is shorter, cleaner, and resembles most real world PDC formats.
echo.
echo.
echo.
echo.
...
echo.
ECHO * * * * * * * * * * * * * * * * *
ECHO    VERSION: BETA 2.1
ECHO    PUBLISHED: 13APR2020 21:00z
ECHO * * * * * * * * * * * * * * * * *
ECHO.
ECHO 1) Removed second query about if a procedure is a DP or not.
echo.
echo 2) Fixed an issue where the .TCRAFT Special Departure Instructions were not reset for a new
echo    procedure for the same airport.
echo.
echo.
echo.
echo.
...
echo.
ECHO * * * * * * * * * * * * * * * * * * *
ECHO    VERSION: BETA 2.0 (and earlier)
ECHO * * * * * * * * * * * * * * * * * * *
ECHO.
